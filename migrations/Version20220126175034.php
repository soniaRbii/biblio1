 ...
 */
final class Version20220126175034 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE empreint (id INT AUTO_INCREMENT NOT NULL, id_livre INT NOT NULL, date_empreint DATE NOT NULL, date_retour DATE NOT NULL, status VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE livre (id INT AUTO_INCREMENT NOT NULL, editeur_id INT NOT NULL, categorie_id INT DEFAULT NULL, titre VARCHAR(50) NOT NULL, isbn VARCHAR(255) NOT NULL, prix INT NOT NULL, qte_stock INT NOT NULL, date_edition DATE NOT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_AC634F993375BD21 (editeur_id), INDEX IDX_AC634F99BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
